<template>
  <form class="card auth-card" @submit.prevent="submitHandler">
    ...
    <div class="card-action">
      <div>
        <button class="btn waves-effect waves-light auth-submit  light-blue accent-3" type="submit">
           {{'Login'|localize}}
...
export default {
  ...
  mounted() {
    if (messages[this.$route.query.message]) {
      this.$simpleMessage(localizeFilter(messages[this.$route.query.message]));
    }
  },
  methods: {
    async submitHandler() {
